...
> *Укзананные данные будут внесены в файл `.env` для обеспечения безопасности приложения 
>(данный файл включен в `.gitignore` и не передается на GitHub, поэтому не забывайте копировать его на другой компьютер, если будете разрабатывать приложение на разных машинах.)
