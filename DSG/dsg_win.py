...
class DjangoStarterGenerator():
    ...
    def initial_script(self):
        ...
        install_script = textwrap.dedent(f"""
                                                ...
                                                echo     - Installing django-bootstrap5...
                                                pip install django-bootstrap5 --quiet
                                                echo     - Installing django-cleanup...
                                                pip install django-cleanup --quiet
                                                echo     - Installing django-sass-processor...
                                                pip install django-sass-processor --quiet
                                                echo     - Installing django-simple-captcha...
                                                pip install django-simple-captcha --quiet
                                                ...
                                                mkdir src
                                                echo     - Creating a project resource directories...
                                                cd src
                                                mkdir static
                                                echo     - Initializing a new Django project {self.project_name}...
