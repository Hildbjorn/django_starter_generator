...
class Messages:
    ...
    ██║  ██║    ╚════██║    ██║   ██║
    ██████╔╝    ███████║    ╚██████╔╝
    ╚═════╝     ╚══════╝     ╚═════╝   [Django Starter Generator] {Colors.RESET}"""

    GREETING = f"""
    Добро пожаловать!

    Django Starter Generator (DSG) — это инструмент,
    для упрощения и ускорения процесса создания новых проектов на базе Django.

    Начинаем создание вашего проекта.
    """
